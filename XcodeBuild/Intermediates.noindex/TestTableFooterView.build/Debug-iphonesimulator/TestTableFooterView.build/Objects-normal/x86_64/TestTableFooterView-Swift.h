...
#ifndef TESTTABLEFOOTERVIEW_SWIFT_H
#define TESTTABLEFOOTERVIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TestTableFooterView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC19TestTableFooterView11AppDelegate")
...
SWIFT_CLASS("_TtC19TestTableFooterView6Footer")
...
SWIFT_CLASS("_TtC19TestTableFooterView13SceneDelegate")
...
SWIFT_CLASS("_TtC19TestTableFooterView14ViewController")
...
@interface ViewController (SWIFT_EXTENSION(TestTableFooterView)) <UITableViewDataSource>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


@interface ViewController (SWIFT_EXTENSION(TestTableFooterView)) <UITableViewDelegate>
